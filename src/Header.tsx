...
export function Header() {
  ...
  return (
    <header className="flex items-center justify-between w-full h-20 bg-gray-800 px-4 text-white">
      ...
      {auth ? (
        <div className="flex items-center">
          ...
          <button onClick={handleLogout} className="bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-4 rounded">
            Logout
          </button>
        </div>
      ) : (
